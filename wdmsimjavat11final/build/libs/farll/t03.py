...
def plot_data():
    ...
    ax1.plot(loads, total_blocked, marker='o', color='r', label='Total Blocked')
    ax1.set_xlabel('Load')
    ...
    ax2.plot(loads, available_bandwidth, marker='o', color='r', label='Available Bandwidth')
    ax2.set_xlabel('Load')
    ...
    ax3.bar(loads, lightpath_counts, color='r', label='Lightpath Created Count', width=1.5)  # Thicker bars
    ax3.set_xlabel('Load')
